          ...
          <v-layout>
            ...
            <v-main class="emap-main-contain" style="line-height: 0;">
              ...
              >
                ...
                <div ref="transformer" class="canvas-transformer" :style="canvasTransformStyle" @mousedown.stop="handleBackgroundMouseDown">
                  <!-- 背景圖 -->
...
<script>
  ...
  import { handleKeydown, cutItems, copyItems, pasteItems, deleteItems, saveHistory, regenerateAllIdnames } from '@/views/Emap/jsfile/keyboard.js'
  ...
  export default {
    ...
    methods: {
      ...
      // 鍵盤函數
      handleKeydown, cutItems, copyItems, pasteItems, deleteItems, saveHistory, regenerateAllIdnames, 
      // ======================================= 組件設定參數 =======================================
      // 取得組件類型
      ...
      exportEmapData() {
        ...
        a.download = `export(${formattedTS}).json`;
...
.group-wrapper.selected>.group-background {
  /* 注意選擇器 > */
